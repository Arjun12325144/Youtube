...
import { Loader2, ThumbsUp, Play, Shuffle } from "lucide-react";
          ...
          <div className="p-3 sm:p-4 lg:p-6 max-w-6xl">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6 sm:mb-8">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="text-xl sm:text-2xl font-bold text-[var(--color-foreground)]">Liked Videos</h1>
                  <p className="text-xs sm:text-sm text-[var(--color-muted-foreground)]">Videos you've liked</p>
                </div>
              </div>

...
//                                 <Input disabled={isUploading || uploadComplete} placeholder="Add a title that describes your video" id="title" value={videoTitle} onChange={(e)=>setVideoTitle(e.target.value)} className='mb-1'/>
...
//                                         Cancel
//                                     </Button>
//                                     <Button disabled={isUploading || !videoTitle.trim() || uploadComplete}> {isUploading?"Uploading...":"Upload"} </Button>
//                                 </>
//                             )}
//                         </div>
//                     </div>
...
const VideoUploader = ({ channelId, channelName }: any) => {
  ...
  const handleUpload = async () => {
    ...
    // Use authenticated user's ID as uploader, fallback to channelId
    ...
    console.log("Upload form data prepared with uploader:", uploaderId);
    try {
      setIsUploading(true);
      setUploadProgress(0);
